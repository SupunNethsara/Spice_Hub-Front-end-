  ...
  return (
    <div>
      <section class="bg-white">
        <div class="gap-2 items-center py-8 px-2 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-2 lg:px-6">
      ...
      <section class="bg-white">
        <div class="gap-2 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-2 lg:px-6">
