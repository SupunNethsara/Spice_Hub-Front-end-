        ...
        <div>
            <section class="bg-gray-50 py-8 antialiased  md:py-12">
                <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                                ...
                                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                    ...
                                    <li aria-current="page">
                                        <div class="flex items-center">
                                            ...
                                            <span class="ms-1 text-sm font-medium md:ms-2">Spices</span>
                                        </div>
                                    </li>
                                </ol>
                            </nav>
                            <h2 class="mt-3 text-xl font-semibold text-gray-900  sm:text-2xl">Spices</h2>
                        </div>
                    ...
                    <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4 text-center justify-center  items-center">
                        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                            <div class="h-56 w-full">
                                <a href="#">
                                    ...
                                    <img class="mx-auto hidden max-w-sm h-full dark:block" src="/images/product1.png" alt="" />
                                </a>
                            </div>
                            <div class="pt-6">
                                ...
                                <div className='grid'>
                                    <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline ">මිරිස් කුඩු
                                    </a>
                                    <a href="#" class="text-sm font-semibold leading-tight text-gray-900 hover:underline mt-3 ">Chili Flakes
                                    </a>
                                </div>
                                ...
                                <div class="mt-4 flex flex-col w-full gap-4">
                                    <p class="text-2xl font-extrabold leading-tight text-gray-900 text-center w-full">LKR.200.00</p>

                                    <button type="button" class="w-full inline-flex justify-center items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium bg-green-400 text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300">
