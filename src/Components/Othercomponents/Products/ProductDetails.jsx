                        ...
                        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                            ...
                            <div className="mt-6 sm:mt-8 lg:mt-0">
                                ...
                                <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl">
                                    {product.product_name} ({product.product_sname})
                                </h1>

                                {/* Price and Rating */}
                                <div className="mt-4 sm:items-center sm:gap-4 sm:flex">
                                    <p className="text-2xl font-extrabold text-gray-900 sm:text-3xl">
                                        <strong>Price:</strong> LKR {product.Product_price}
                                    </p>
                                ...
                                <div className="mt-6 space-y-4">
                                    ...
                                    <p className="text-gray-700">
                                        <strong>Weight:</strong> {product.weight} {product.unit_of_measurement}
                                    </p>
                                    <p className="text-gray-700">
                                ...
                                <p className="mb-6 text-gray-950">{product.Product_description}</p>
