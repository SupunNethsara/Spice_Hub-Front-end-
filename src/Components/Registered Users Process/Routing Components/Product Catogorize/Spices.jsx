...
function Spices() {
  ...
  // Alternatively, if you want to filter on the backend, you could modify the API call:
  // useEffect(() => {
  //   axios.get('http://localhost:8000/api/getOrder?category=Spices')
  //     .then(res => {
